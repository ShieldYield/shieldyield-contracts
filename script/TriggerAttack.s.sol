...
contract TriggerAttack is Script {
    ...
    function run() external {
        ...
        console.log(unicode"  ⚠️ TRIGGERING ON-CHAIN ATTACK SIMULATION ⚠️");
        console.log(
            "=========================================================="
        );
        ...
        console.log(
            "  -> Risk score for YieldMax successfully updated to 95 (CRITICAL)."
        );
        console.log(
            "  -> Event 'RiskScoreUpdated' emitted to Arbitrum Sepolia."
        );
        console.log(
            "  -> NOW: Check your running CRE workflow. It should respond to this event!"
        );
        console.log(
            "=========================================================="
        );
